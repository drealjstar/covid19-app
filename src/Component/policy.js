            ...
            <div>
                ...
                <div className="policies">
                    ...
                    <div className="policy_intro">
                        <h2>Introduction</h2>
                        <p>We are health care organization that currently contribute to the eradication of Covid-19 disease</p>
                    ...
                    <div className="responsibility">
                        ...
                        <p>as we have pledge to render the best of our services to you. Your personal data provided to us</p>
                    ...
                    <div className="data_collection">
                        ...
                        <p>We are able to get our client personal data through the online form on our organization website</p>
                        <p>We collected personal information of our client for professional and functional reasons.</p>
                    </div>

                    <div className="data_usage">
                        <h2>How we use your Personal Data</h2>
                        <p>We use the personal data you provide to make sure we serve you well, by rendering a standard service </p>
                        <p>to you.</p>
                    </div>
